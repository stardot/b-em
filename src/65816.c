...
static void makeopcodetable65816(void)
{
    int c, d;
    for (c = 0; c < 256; c++) {
        for (d = 0; d < 5; d++) {
    ...
    opcodes[0xC2][0] = opcodes[0xC2][1] = opcodes[0xC2][2] = opcodes[0xC2][3] = opcodes[0xC2][4] = rep65816;
    ...
    /*Misc group */
    opcodes[0x00][0] = opcodes[0x00][1] = opcodes[0x00][2] = opcodes[0x00][3] = op_brk;
    opcodes[0x00][4] = brke;
    opcodes[0x02][0] = opcodes[0x02][1] = opcodes[0x02][2] = opcodes[0x02][3] = cop;
    opcodes[0x02][4] = cope;
    ...
    opcodes[0x42][0] = opcodes[0x42][1] = opcodes[0x42][2] = opcodes[0x42][3] = opcodes[0x42][4] = wdm;
    opcodes[0xDB][0] = opcodes[0xDB][1] = opcodes[0xDB][2] = opcodes[0xDB][3] = opcodes[0xDB][4] = stp;
}
