...
/*                if (a==0xFEFB && temp==0xD)
	...
	if ((a & 0x78000) == 0x4000 && !def && (banking & 1))
		return w65816ram[(a & 0x3FFF) | ((banknum & 7) << 14)];
	if ((a & 0x78000) == 0x8000 && !def && (banking & 2))
...
//                printf("Write control %04X %02X\n",a,v);
		...
		case 0:
		case 1:
			def = v & 1;	/*bem_debugf("Default now %i\n",def); */
			break;
		case 2:
		case 3:
			divider = (divider >> 1) | ((v & 1) << 3);	/*bem_debugf("Divider now %i\n",divider); */
			break;
		case 4:
		case 5:
			banking = (banking >> 1) | ((v & 1) << 3);	/*bem_debugf("Banking now %i\n",banking); */
			break;
		case 6:
		case 7:
			banknum = (banknum >> 1) | ((v & 1) << 5);	/*bem_debugf("Banknum now %i\n",banknum); */
			break;
		}
		if (def || !(banking & 4))
			w65816mask = 0xFFFF;
...
static void makeopcodetable65816()
{
	...
	opcodes[0xB3][0] = opcodes[0xB3][2] = opcodes[0xB3][4] =
	    ldaSIndirecty8;
	...
	opcodes[0xA1][0] = opcodes[0xA1][2] = opcodes[0xA1][4] =
	    ldaIndirectx8;
	opcodes[0xA1][1] = opcodes[0xA1][3] = ldaIndirectx16;
	opcodes[0xB1][0] = opcodes[0xB1][2] = opcodes[0xB1][4] =
	    ldaIndirecty8;
	opcodes[0xB1][1] = opcodes[0xB1][3] = ldaIndirecty16;
	opcodes[0xA7][0] = opcodes[0xA7][2] = opcodes[0xA7][4] =
	    ldaIndirectLong8;
	opcodes[0xA7][1] = opcodes[0xA7][3] = ldaIndirectLong16;
	opcodes[0xB7][0] = opcodes[0xB7][2] = opcodes[0xB7][4] =
	    ldaIndirectLongy8;
	...
	opcodes[0x81][0] = opcodes[0x81][2] = opcodes[0x81][4] =
	    staIndirectx8;
	opcodes[0x81][1] = opcodes[0x81][3] = staIndirectx16;
	opcodes[0x91][0] = opcodes[0x91][2] = opcodes[0x91][4] =
	    staIndirecty8;
	opcodes[0x91][1] = opcodes[0x91][3] = staIndirecty16;
	opcodes[0x87][0] = opcodes[0x87][2] = opcodes[0x87][4] =
	    staIndirectLong8;
	opcodes[0x87][1] = opcodes[0x87][3] = staIndirectLong16;
	opcodes[0x97][0] = opcodes[0x97][2] = opcodes[0x97][4] =
	    staIndirectLongy8;
	...
	opcodes[0x93][0] = opcodes[0x93][2] = opcodes[0x93][4] =
	    staSIndirecty8;
	...
	opcodes[0x21][0] = opcodes[0x21][2] = opcodes[0x21][4] =
	    andIndirectx8;
	opcodes[0x21][1] = opcodes[0x21][3] = andIndirectx16;
	opcodes[0x31][0] = opcodes[0x31][2] = opcodes[0x31][4] =
	    andIndirecty8;
	opcodes[0x31][1] = opcodes[0x31][3] = andIndirecty16;
	opcodes[0x33][0] = opcodes[0x33][2] = opcodes[0x33][4] =
	    andsIndirecty8;
	opcodes[0x33][1] = opcodes[0x33][3] = andsIndirecty16;
	opcodes[0x27][0] = opcodes[0x27][2] = opcodes[0x27][4] =
	    andIndirectLong8;
	opcodes[0x27][1] = opcodes[0x27][3] = andIndirectLong16;
	opcodes[0x37][0] = opcodes[0x37][2] = opcodes[0x37][4] =
	    andIndirectLongy8;
	...
	opcodes[0x41][0] = opcodes[0x41][2] = opcodes[0x41][4] =
	    eorIndirectx8;
	opcodes[0x41][1] = opcodes[0x41][3] = eorIndirectx16;
	opcodes[0x51][0] = opcodes[0x51][2] = opcodes[0x51][4] =
	    eorIndirecty8;
	opcodes[0x51][1] = opcodes[0x51][3] = eorIndirecty16;
	opcodes[0x53][0] = opcodes[0x53][2] = opcodes[0x53][4] =
	    eorsIndirecty8;
	opcodes[0x53][1] = opcodes[0x53][3] = eorsIndirecty16;
	opcodes[0x47][0] = opcodes[0x47][2] = opcodes[0x47][4] =
	    eorIndirectLong8;
	opcodes[0x47][1] = opcodes[0x47][3] = eorIndirectLong16;
	opcodes[0x57][0] = opcodes[0x57][2] = opcodes[0x57][4] =
	    eorIndirectLongy8;
	...
	opcodes[0x01][0] = opcodes[0x01][2] = opcodes[0x01][4] =
	    oraIndirectx8;
	opcodes[0x01][1] = opcodes[0x01][3] = oraIndirectx16;
	opcodes[0x11][0] = opcodes[0x11][2] = opcodes[0x11][4] =
	    oraIndirecty8;
	opcodes[0x11][1] = opcodes[0x11][3] = oraIndirecty16;
	opcodes[0x13][0] = opcodes[0x13][2] = opcodes[0x13][4] =
	    orasIndirecty8;
	opcodes[0x13][1] = opcodes[0x13][3] = orasIndirecty16;
	opcodes[0x07][0] = opcodes[0x07][2] = opcodes[0x07][4] =
	    oraIndirectLong8;
	opcodes[0x07][1] = opcodes[0x07][3] = oraIndirectLong16;
	opcodes[0x17][0] = opcodes[0x17][2] = opcodes[0x17][4] =
	    oraIndirectLongy8;
	...
	opcodes[0x61][0] = opcodes[0x61][2] = opcodes[0x61][4] =
	    adcIndirectx8;
	opcodes[0x61][1] = opcodes[0x61][3] = adcIndirectx16;
	opcodes[0x71][0] = opcodes[0x71][2] = opcodes[0x71][4] =
	    adcIndirecty8;
	opcodes[0x71][1] = opcodes[0x71][3] = adcIndirecty16;
	opcodes[0x73][0] = opcodes[0x73][2] = opcodes[0x73][4] =
	    adcsIndirecty8;
	opcodes[0x73][1] = opcodes[0x73][3] = adcsIndirecty16;
	opcodes[0x67][0] = opcodes[0x67][2] = opcodes[0x67][4] =
	    adcIndirectLong8;
	opcodes[0x67][1] = opcodes[0x67][3] = adcIndirectLong16;
	opcodes[0x77][0] = opcodes[0x77][2] = opcodes[0x77][4] =
	    adcIndirectLongy8;
	...
	opcodes[0xE1][0] = opcodes[0xE1][2] = opcodes[0xE1][4] =
	    sbcIndirectx8;
	opcodes[0xE1][1] = opcodes[0xE1][3] = sbcIndirectx16;
	opcodes[0xF1][0] = opcodes[0xF1][2] = opcodes[0xF1][4] =
	    sbcIndirecty8;
	opcodes[0xF1][1] = opcodes[0xF1][3] = sbcIndirecty16;
	opcodes[0xF3][0] = opcodes[0xF3][2] = opcodes[0xF3][4] =
	    sbcsIndirecty8;
	opcodes[0xF3][1] = opcodes[0xF3][3] = sbcsIndirecty16;
	opcodes[0xE7][0] = opcodes[0xE7][2] = opcodes[0xE7][4] =
	    sbcIndirectLong8;
	opcodes[0xE7][1] = opcodes[0xE7][3] = sbcIndirectLong16;
	opcodes[0xF7][0] = opcodes[0xF7][2] = opcodes[0xF7][4] =
	    sbcIndirectLongy8;
	...
	opcodes[0xC1][0] = opcodes[0xC1][2] = opcodes[0xC1][4] =
	    cmpIndirectx8;
	opcodes[0xC1][1] = opcodes[0xC1][3] = cmpIndirectx16;
	opcodes[0xD1][0] = opcodes[0xD1][2] = opcodes[0xD1][4] =
	    cmpIndirecty8;
	opcodes[0xD1][1] = opcodes[0xD1][3] = cmpIndirecty16;
	opcodes[0xD3][0] = opcodes[0xD3][2] = opcodes[0xD3][4] =
	    cmpsIndirecty8;
	opcodes[0xD3][1] = opcodes[0xD3][3] = cmpsIndirecty16;
	opcodes[0xC7][0] = opcodes[0xC7][2] = opcodes[0xC7][4] =
	    cmpIndirectLong8;
	opcodes[0xC7][1] = opcodes[0xC7][3] = cmpIndirectLong16;
	opcodes[0xD7][0] = opcodes[0xD7][2] = opcodes[0xD7][4] =
	    cmpIndirectLongy8;
...
void w65816_init()
{
	...
	char            fn[512];
	if (!w65816rom)
		w65816rom = malloc(0x8000);
	if (!w65816ram)
		w65816ram = malloc(0x80000);
...
void w65816_exec()
{
	while (tubecycles > 0) {
		...
		if (toutput)
			bem_debugf
			    ("%i : %02X:%04X %04X %02X %i %04X  %04X %04X %04X\n",
			    wins, pbr, pc - 1, toldpc, opcode, cycles, s.b.l,
			    a.w, x.w, y.w);
		toldpc = pc - 1;
