...
typedef enum {
    ...
    IDM_DISC_LOAD,
    IDM_DISC_EJECT,
    IDM_DISC_NEW_DFS_SINGLE,
    IDM_DISC_NEW_DFS_INTERLEAVED,
    IDM_DISC_NEW_ADFS_SEQ_SMALL,
    IDM_DISC_NEW_ADFS_SEQ_LARGE,
    IDM_DISC_NEW_ADFS_INTERLEAVED,
    IDM_DISC_NEW_DDFS_SINGLE_16S,
    IDM_DISC_NEW_DDFS_SINGLE_18S,
    IDM_DISC_NEW_DDFS_INTERLEAVED_16S,
    IDM_DISC_NEW_DDFS_INTERLEAVED_18S,
    IDM_DISC_WPROT,
    IDM_DISC_WPROT_D,
    IDM_DISC_HARD_IDE,
    IDM_DISC_HARD_SCSI,
