    ...
    case 0x6a:
        {
            ...
            Rm = ((state->Reg[AEBITS (0, 3)] >> ror) & 0xFF);
            if (Rm & 0x80)
                Rm |= 0xffffff00;

            if (AEBITS (16, 19) == 0xf)
                /* SXTB */
                state->Reg[AEBITS (12, 15)] = Rm;
            else
                /* SXTAB */
                state->Reg[AEBITS (12, 15)] += Rm;
        }
    ...
    case 0x6b:
        {
            ...
            Rm = ((state->Reg[AEBITS (0, 3)] >> ror) & 0xFFFF);
            if (Rm & 8000)
                Rm |= 0xffff0000;
            ...
            if (AEBITS (16, 19) == 0xf)
                ...
                /* SXTAH */
                state->Reg[AEBITS (12, 15)] = state->Reg[AEBITS (16, 19)] + Rm;
        }
        return 1;
...
#endif
{
    ...
    do
    {
        ...
        if ((temp = AETOPBITS (28)) == AL)
            /* Vile deed in the need for speed.  */
            goto mainswitch;

        /* Check the condition code.  */
        switch ((int) AETOPBITS (28))
        {
        case AL:
            temp = TRUE;
            break;
        case NV:
            if (state->is_v5)
            {
                if (AEBITS (25, 27) == 5) /* BLX(1) */
                {
                    ...
                    dest = pc + 8 + 1;
                    if (AEBIT (23))
                        dest += (NEGBRANCH + (AEBIT (24) << 1));
                    else
                        dest += POSBRANCH + (AEBIT (24) << 1);
...
mainswitch:
            ...
            if (state->is_XScale)
            {
                if (AEBIT (20) == 0 && AEBITS (25, 27) == 0)
                {
                    if (AEBITS (4, 7) == 0xD)
                    {
                        /* XScale Load Consecutive insn.  */
                        ARMword temp = GetLS7RHS (state, instr);
                        ARMword temp2 = AEBIT (23) ? LHS + temp : LHS - temp;
                        ARMword addr = AEBIT (24) ? temp2 : LHS;
                        ...
                        {
                            int wb = AEBIT (21) || (! AEBIT (24));

                            state->Reg[AEBITS (12, 15)] =
                                ARMul_LoadWordN (state, addr);
                            state->Reg[AEBITS (12, 15) + 1] =
            ...
            case 0x10:		/* TST reg and MRS CPSR and SWP word.  */
                if (state->is_v5e)
                {
                    if (AEBIT (4) == 0 && AEBIT (7) == 1)
                    {
                        ...
                        ARMword op1 = state->Reg[AEBITS (0, 3)];
                        ARMword op2 = state->Reg[AEBITS (8, 11)];
                        ARMword Rn = state->Reg[AEBITS (12, 15)];
                    ...
                    if (AEBITS (4, 11) == 5)
                    {
                        /* ElSegundo QADD insn.  */
                        ARMword op1 = state->Reg[AEBITS (0, 3)];
                        ARMword op2 = state->Reg[AEBITS (16, 19)];
            ...
            case 0x12:		/* TEQ reg and MSR reg to CPSR (ARM6).  */
                ...
                {
                    if (AEBIT (4) == 0 && AEBIT (7) == 1
                        && (AEBIT (5) == 0 || AEBITS (12, 15) == 0))
                    {
                        /* ElSegundo SMLAWy/SMULWy insn.  */
                        ARMdword op1 = state->Reg[AEBITS (0, 3)];
                        ARMdword op2 = state->Reg[AEBITS (8, 11)];
                        ARMdword result;
                        ...
                        state->Reg[AEBITS (16, 19)] = (ARMword)result;
                        break;
                    }
            ...
            case 0x14:		/* CMP reg and MRS SPSR and SWP byte.  */
                if (state->is_v5e)
                {
                    if (AEBIT (4) == 0 && AEBIT (7) == 1)
                    {
                        ...
                        dest = (ARMdword) state->Reg[AEBITS (16, 19)] << 32;
                        dest |= state->Reg[AEBITS (12, 15)];
                        dest += op1 * op2;
                        state->Reg[AEBITS (12, 15)] = (ARMword)dest;
                        state->Reg[AEBITS (16, 19)] = (ARMword)(dest >> 32);
                        break;
                    }
            ...
            case 0x16:		/* CMN reg and MSR reg to SPSR */
                if (state->is_v5e)
                {
                    if (AEBIT (4) == 0 && AEBIT (7) == 1 && AEBITS (12, 15) == 0)
                    {
                        ...
                        state->Reg[AEBITS (16, 19)] = op1 * op2;
                        break;
                    }
                ...
                if (state->is_v5)
                {
                    if (AEBITS (4, 11) == 0xF1 && AEBITS (16, 19) == 0xF)
                    {
                        /* ARM5 CLZ insn.  */
                        ARMword op1 = state->Reg[AEBITS (0, 3)];
                        int result = 32;
            ...
            case 0xc4:
                if (state->is_v5)
                {
                    ...
                    if (AEBITS (12, 15) == 15 || AEBITS (16, 19) == 15)
                        ARMul_UndefInstr (state, instr);
                    ...
                    else if (state->is_XScale)
                    {
                        ...
                        else if (AEBITS (0, 3) != 0x00)
                            ARMul_UndefInstr (state, instr);
                        else
                        {
                            /* XScale MAR insn.  Move two registers into accumulator.  */
                            state->Accumulator = state->Reg[AEBITS (12, 15)];
                            state->Accumulator += (ARMdword) state->Reg[AEBITS (16, 19)] << 32;
                        }
                    }
                    else
                ...
                if (state->is_v5)
                {
                    ...
                    else if (state->is_XScale)
                    {
                        ...
                        else
                        {
                            ...
                            state->Reg[AEBITS (12, 15)] = (ARMword)state->Accumulator;
                            state->Reg[AEBITS (16, 19)] = t1;
                            break;
                        }
                    }
                    else
            ...
            case 0xe2:
                ...
                {
                    case 0x0:
                        if (AEBITS (4, 11) == 1 && AEBITS (16, 17) == 0)
                        {
            ...
            case 0xff:
                ...
                if (!ARMul_OSHandleSWI (state, AEBITS (0, 23)))
                    ARMul_Abort (state, ARMul_SWIV);
                break;
            }
        }
...
GetDPRegRHS (ARMul_State * state, ARMword instr)
{
    ...
    if (AEBIT (4))
    {
        ...
        shamt = state->Reg[AEBITS (8, 11)] & 0xff;
        switch ((int) AEBITS (5, 6))
        {
        case LSL:
            if (shamt == 0)
                return (base);
...
GetLS7RHS (ARMul_State * state, ARMword instr)
{
    ...
    /* Immediate.  */
    return AEBITS (0, 3) | (AEBITS (8, 11) << 4);
}
...
Handle_Load_Double (ARMul_State * state, ARMword instr)
{
    ...
    /* Compute the offset.  */
    offset = immediate ? ((AEBITS (8, 11) << 4) | AEBITS (0, 3)) : state->Reg[RHSReg];
...
LoadMult (ARMul_State * state, ARMword instr, ARMword address, ARMword WBBase)
{
    ...
    for (; temp < 16; temp ++)
        ...
        if (AEBIT (15) && !state->Aborted)
            /* PC is in the reg list.  */
            WriteR15Branch (state, AE_PC);
           ...
           ARMword       WBBase)
{
    ...
    if (!AEBIT (15) && state->Bank != USERBANK)
    {
    ...
    for (; temp < 16; temp++)
        ...
        if (!AEBIT (15) && state->Mode != USER26MODE && state->Mode != USER32MODE)
