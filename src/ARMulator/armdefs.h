...
#define AEBIT(n) ( (ARMword)(instr>>(n))&1)	/* bit n of instruction */
#define AEBITS(m,n) ( (ARMword)(instr<<(31-(n))) >> ((31-(n))+(m)) )	/* bits m to n of instr */
#define AETOPBITS(n) (instr >> (n))	/* bits 31 to n of instr */
