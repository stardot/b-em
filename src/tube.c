...
void tube_updateints()
{
	...
	if ((tubeula.r1stat & 2) && (tubeula.pstat[0] & 128))
		tube_irq |= 1;
	if ((tubeula.r1stat & 4) && (tubeula.pstat[3] & 128))
		tube_irq |= 1;

	if ((tubeula.r1stat & 8) && !(tubeula.r1stat & 16)
	    && ((tubeula.hp3pos > 0) || (tubeula.ph3pos == 0)))
		tube_irq |= 2;
	if ((tubeula.r1stat & 8) && (tubeula.r1stat & 16)
	    && ((tubeula.hp3pos > 1) || (tubeula.ph3pos == 0)))
		tube_irq |= 2;
}
...
void tube_reset()
{
	...
	tubeula.pstat[0] = tubeula.pstat[1] = tubeula.pstat[2] =
	    tubeula.pstat[3] = 0x40;
