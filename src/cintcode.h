/* Types, tables and functions to enable disassembling the CINTCODE
 * used as an intermediate code for BCPL on the RCP implementation
 * for the BBC Micro.
 */
...
/* Table of CINTCODE global names (Global Vector) */

#define CINTCODE_NGLOB 220

extern const char cintocde_globs[CINTCODE_NGLOB][13];

/* CINTCODE related functions. */

extern void cintcode_trace(cpu_debug_t *cpu, uint32_t cc_addr, FILE *trace_fp);
