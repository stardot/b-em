...
void dumpuservia()
{
        bem_log(LOG_DEBUG, "T1 = %04X %04X T2 = %04X %04X",uservia.t1c,uservia.t1l,uservia.t2c,uservia.t2l);
        bem_log(LOG_DEBUG, "%02X %02X  %02X %02X",uservia.ifr,uservia.ier,uservia.pcr,uservia.acr);
}
